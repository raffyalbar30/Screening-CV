      ...
      <div className={`mt-16 ${font.className}`}>
          ...
          <div className="flex justify-center">
            <div className="flex-wrap">
              <p className="lg:text-xl sm:text-[10px] md:text-[13px] text-center text-[10px] ">CV ATS Scanner adalah sebuah tools buat kamu para Jobseker, Perbaiki CV mu dalam penulisan dan tata bahasa </p>
