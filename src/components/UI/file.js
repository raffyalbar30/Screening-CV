...
export default function FileUploader({setfile}) {
  return (
    ...
    <input accept="application/pdf" onChange={(e) => {setfile(e.target.files[0])}} className="mx-auto opacity-0 absolute mt-4 " type="file" id="resumme" name="resumefile" multiple />
